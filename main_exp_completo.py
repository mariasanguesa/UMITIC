...
def main(path):
    ...
    # for i in np.arange(1.5, 3.5, 0.3):
...
if __name__ == "__main__":    
    path = "D:/msanguesa/STEP_Mama_HER2_primary_recurrence_filtered/"    
    # path = "D:/msanguesa/STEP_Mama_HER2_good_recurrence_filtered/" 
    # path = "D:/msanguesa/STEP_Mama_good_recurrence_filtered/" 
    # path = "D:/msanguesa/STEP_Mama_HER2_good_recurrence_tumoral_filtered_Olivia/"    
    # path = "D:/msanguesa/STEP_Mama_HER2_good_recurrence_immune_filtered/"   
    # path = "d:/msanguesa/01_Experiment_Panel33C/exp_seg_maria/"        
    main(path) 