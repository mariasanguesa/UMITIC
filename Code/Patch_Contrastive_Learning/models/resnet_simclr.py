...
from Code.Patch_Contrastive_Learning.exceptions.exceptions import InvalidBackboneError
...
class ResNetSimCLR_pretrained(nn.Module):
    ...
    def __init__(self, in_channels, base_model, out_dim):
        ...
        self.resnet_dict = {"resnet50": models.resnet50(weights=ResNet50_Weights.DEFAULT),"resnet18": models.resnet18(weights=ResNet18_Weights.DEFAULT)}#, num_classes=out_dim)}
